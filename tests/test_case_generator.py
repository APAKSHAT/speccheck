...
class TestBoundaryCases:
    ...
    def test_below_min_length(self, post_cases):
        ...
        min_len_cases = [
            c
            for c in boundary
            if "minLength" in c.description.lower() or "below minlength" in c.description.lower()
        ]
    ...
    def test_above_max_length(self, post_cases):
        ...
        max_cases = [
            c
            for c in boundary
            if "maxlength" in c.description.lower() or "above maxlength" in c.description.lower()
        ]
